...
export const OverlapGroupWrapperByAnima = () => {
  return (
    <Card className="relative w-full max-w-[792px] h-[500px] rounded-xl overflow-hidden bg-[url('https://c.animaapp.com/madvybnqLmC56e/img/image-9.png')] bg-cover bg-center">
